...
export default function New() {
  ...
  return (
    <>
      <main className="bg-blue-1000 w-full h-full ">
        <section className="flex flex-col items-center">
            ...
            <div className="flex max-[280px]:flex-col 
            justify-evenly 
            max-[280px]:items-center
            w-full 
            h-4/5 
            max-[280px]:mt-0 mt-10">
              ...
              >
                ...
                justify-evenly 
                items-center 
                max-[280px]:w-full w-3/5 
                h-[40rem]">
                  <input
                    className="w-full h-8 rounded-md p-1"
                    type="text"
                    name="name"
                  ...
                  />
                  <button className="bg-orange-1000 w-11/12 font-bold text-white text-md rounded-lg py-1">Create a Cover Letter</button>
                </section>
              </Form>
              {/* Example Paper */}
              <section className="bg-white 
              max-[280px]:w-11/12 w-[40rem] 
              text-left 
              max-[280px]:text-sm text-xl 
              p-5 
              flex flex-col 
              justify-between 
              shadow-lg
